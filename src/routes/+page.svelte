<script>
  import { ButtonPrimary, LanguageIcon } from "$lib/components/";
...
<section class="max-w-screen-xl mx-auto px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16 grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-16">
    ...
    >
        ...
        On this blog, you will find all the ressources you need to be the
        greatest developer in the world.
        </p>
    ...
    <div class="grid grid-cols-2 gap-4 sm:grid-cols-3">
        ...
        >
            ...
            <h2 class="mt-2 font-bold">{language}</h2>

            <p class="hidden sm:mt-1 sm:block sm:text-sm sm:text-gray-600">
            All the {language} related articles
            </p>
        </a>
        {/each}
    </div>
